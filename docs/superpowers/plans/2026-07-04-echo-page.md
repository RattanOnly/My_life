...
The following are intentionally excluded from this plan: production-grade character illustration beyond the first SVG version, birthday gift-box animation, weather system, voice chat, visitor accounts, saved transcripts, and forum features.
